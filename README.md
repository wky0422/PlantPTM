# <div align="center" style="display: flex; align-items: center; justify-content: center; gap: 0px;"><img src="images/logo.png" width="60"><h2 style="margin-top: -10px;">PlantPTM</h2></div>
