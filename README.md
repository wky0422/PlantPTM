# <div align="center" style="display: flex; align-items: center; justify-content: center; gap: 0px;"><img src="images/logo.png" width="40"><h1 style="margin: 0;">PlantPTM</h1></div>
